package com.example.giveAndTake_app.fragments.auth;
...
import com.example.giveAndTake_app.AuthReplacerActivity;
import com.example.giveAndTake_app.MainActivity;
...
public class LoginFragment extends Fragment {
    ...
    private void clickListener() {
        ...
        signUpTv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ((AuthReplacerActivity) getActivity()).setFragment(new CreateAccountFragment());
            }
        });
    }
